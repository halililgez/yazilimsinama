...
namespace proje3
{
    public partial class frmToDo : Form
    {
        ...
        {   
            ...
            baglanti.Open();
            SqlCommand yeniis = new SqlCommand("insert into [is_takip_table](projeid,projeadi,kartno,tarih,ad,kisi,aciklama) values(@projeid,@projeadi,@kartno,@tarih,@ad,@kisi,@aciklama)", baglanti);
